      ...
      <div className="space-y-4">
        ...
        <div className="rounded-xl border border-chrome bg-white p-4 shadow-sm">
          ...
          <form action={createUserAction} className="mt-3 space-y-4">
            ...
            <label className="space-y-1 text-sm text-slate-700"><span className="block text-xs font-medium text-slate-500">Status</span><select name="status" defaultValue="pending_activation" className="w-full rounded-lg border border-chrome bg-slate-50 px-3 py-2 text-sm text-slate-700"><option value="pending_activation">pending_activation</option><option value="active">active</option><option value="suspended">suspended</option><option value="disabled">disabled</option></select></label>
            <label className="space-y-1 text-sm text-slate-700"><span className="block text-xs font-medium text-slate-500">Initial Password</span><input type="password" name="password" placeholder="Optional initial password" className="w-full rounded-lg border border-chrome bg-slate-50 px-3 py-2 text-sm text-slate-700" autoComplete="new-password" /></label>
            <label className="flex items-center gap-2 text-sm text-slate-700"><input type="checkbox" name="requirePasswordReset" defaultChecked /> Require password reset</label>
